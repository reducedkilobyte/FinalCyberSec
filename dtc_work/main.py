...
# In the embedded area of each block, select the 8 positions in the middle of the intermediate frequency
embedZone = [(0,7),(1,6),(2,5),(3,4),(4,3),(5,2),(6,1),(7,0)]

def resize2octa(imgPath): 
    '''
    In order to be able to divide the 8x8 matrix later, this function riszes the image into multiples of 8x8
    '''
...
def divideBlock(img):
    '''
    Divide the image into 8x8 blocks and return a list that stores all the block informationa
    '''
